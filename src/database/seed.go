...
func seedUsuarios() {
	...
	usuarios := []interface{}{
		bson.D{
			...
			{Key: "senha", Value: "$2a$10$V5gQXzfd5ERDSiYGKvrNHu.YQDoODMUVAb9k.1pHWOEZjYnWMnh/S"},
		},
		bson.D{
			{Key: "_id", Value: 2},
...
func seedPerfis() {
	...
	perfis := []interface{}{
		bson.D{
			...
			{Key: "nivel", Value: "intermediário"},
			{Key: "estilo", Value: "argumentativo"},
		},
		bson.D{
			{Key: "_id", Value: 2},
			...
			{Key: "nivel", Value: "avançado"},
			{Key: "estilo", Value: "silencioso"},
		},
		bson.D{
			{Key: "_id", Value: 3},
